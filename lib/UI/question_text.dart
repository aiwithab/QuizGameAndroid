...
class QuestoinText extends StatefulWidget {
  
  final String _question;
  final int _questionNumber;

  QuestoinText(this._question, this._questionNumber);
...
class QuestionTextState extends State<QuestoinText> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(QuestoinText oldWidget) {
